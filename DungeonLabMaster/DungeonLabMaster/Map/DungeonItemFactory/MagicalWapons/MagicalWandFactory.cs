...
public class MagicalWandFactory: IFactoryDep
{
    ...
    public IItem Create()
    {
        ...
        return new MagicalWand(Random.Shared.Next(_minAttack, _maxAttack+1), Random.Shared.Next(_minDefense,_maxDefense));
    }
}